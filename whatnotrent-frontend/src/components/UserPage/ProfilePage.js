    ...
    <div className={"mt-5 w-75 m-auto"}>
      <Row className={"justify-content-start"} style={{ marginLeft: "0px" }}>
        <Card className={"mb-3 w-50"}>
          <Card.Body className={"fw-bold fs-5 text-center"}>
            Your Profile
          </Card.Body>
        </Card>
      </Row>
      <Row>
        <Col
          className={
            "mb-3 mb-lg-0 col-12 col-lg-4 d-flex flex-column justify-content-between"
          }
        >
          ...
          <Card className={"bg-white text-dark p-3 w-100 mb-3 mb-lg-0"}>
            <ListGroup>
              <ListGroup.Item>
                You have {productList.length} anouncements posted.
              </ListGroup.Item>
              <ListGroup.Item>
                Click on an anouncement to inspect it.
              </ListGroup.Item>
            </ListGroup>
          </Card>
          <Link
        ...
        <Col className={"col-12 col-lg-8"}>
          <Card className={"g-white text-dark shadow w-100 ratio-1x1"}>
            <Card.Img
              ref={image}
              src={photoUrl}
